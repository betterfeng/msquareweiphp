...
<div class="main_body">
  ...
  <ul class="tab-nav nav">
    <li class="current"> <a href="#"><?php echo isset($info['id'])?'编辑':'新增';?>分类<span class="arrow fa fa-sort-up"></span> </a> </li>
    </volist>
  </ul>
  <div class="tab-wrap">
    <div class="tab-content">
      <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
          <label class="item-label">上级分类:<span class="check-tips"><?php echo ((isset($category['title']) && ($category['title'] !== ""))?($category['title']):'无'); ?></span></label>
        </div>
        <div class="form-item">
        ...
        <?php if(!empty($group["has_admin"])): ?><div class="form-item">
          <label class="item-label"> 管理员<span class="check-tips">（这里输入管理员的ID）</span> </label>
          <div class="controls">
            <input type="text" name="admin_uids" class="text input-large" value="<?php echo ((isset($info["admin_uids"]) && ($info["admin_uids"] !== ""))?($info["admin_uids"]):''); ?>">
          </div>
        </div><?php endif; ?>
