...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>     
        ...
        <div class="fl">
          <?php if(empty($model["extend"])): ?><div class="tools">
				<?php if($add_button): $add_url || $add_url = U('add?model='.$model['id'].'&module='.$_GET['module']); ?><a class="btn" href="<?php echo ($add_url); ?>">新 增</a><?php endif; ?>

                <a class="btn" href="<?php echo U('inputData?model='.$model['id'].'&module='.$_GET['module']);?>">导入本组数据</a>
                <a class="btn" href="<?php echo U('exportData?model='.$model['id'].'&module='.$_GET['module']);?>">导出本组数据</a>              
			</div><?php endif; ?>
        </div>
        </div>
	...
	<div class="tb-unit data-table posr">
		<div class="category">
			<div class="hd cf">
                ...
                <?php if(!empty($group["has_admin"])): ?><div class="has_admin">管理员</div><?php endif; ?>                
...
(function(){
	...
	<script type="text/javascript">
		(function($){
			...
			$(".category <?php echo ($level_path); ?> .add-sub-cate").remove();
